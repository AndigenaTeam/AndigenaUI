...
export default class Announcement extends React.Component {
    ...
    componentDidMount() {
        // load normalize css through require as it messes up other pages
        ...
        //document.getElementById("bootstrapcss").remove();
        ...
        //document.getElementsByTagName("style").item(0).remove();
    }
