...
export default class Announcement extends React.Component {
                                    ...
                                    <li className="home__slide">
                                        <div className="home__menu-item home__menu-item--active">
                                            <img src="https://sdk.hoyoverse.com/upload/announcement/2020/03/05/a2588f1a51faee9fa8dfe9aead649dd6_7237021399135895303.png" draggable="false" className="home__tag" alt={""}/>
                                                <div className="home__intro home__intro--active"><p>First element (active)</p></div>
                            ...
                            <div className="home__right">
                                <div className="home__article-wrap">
                                    <div className="home__article">
                                        <h1 className="home__title">Version 3.7 "Duel! The Summoners' Summit!" New Content Overview</h1>
                                        <div>
                                            <p style={{whiteSpace: "pre-wrap"}}>This is example content of announcement.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    componentDidMount() {
        document.getElementsByTagName("html").item(0).style = "font-size: 25vh;";
